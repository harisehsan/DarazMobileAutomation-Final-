...
public class MemberChangeAccountInfoSteps extends BaseSteps {
    ...
    public void iChangeDateOfBirth() throws InterruptedException {
       ...
       Global.getMap().put("current_date_of_birth",current_year+"-"+current_month+"-"+current_day);
    }
    ...
    public void iChangeTheGender() throws InterruptedException {
        ...
        Global.getMap().put("current_gender",current_gender);
    }
    ...
    public void  iChangeTheTaxCode() {
         ...
         Global.getMap().put("edit_tax_number",edittaxnumber);
    }
    ...
    public void iChangeTheBranchId() {
        ...
        Global.getMap().put("edit_branch_id",editbranchid);
    }
    ...
    public void iShouldSeeNewInfoOnPersonalProfilePage() {
        ...
        String expectDateOfBirth = (String) Global.getMap().get("current_date_of_birth");
        String expectGender = (String) Global.getMap().get("current_gender");
        String expectTaxCode  = (String) Global.getMap().get("edit_tax_number");
        String expectBranchId = (String) Global.getMap().get("edit_branch_id");
